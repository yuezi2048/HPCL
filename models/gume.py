...
class GUME(GeneralRecommender):
    def __init__(self, config, dataset):
        ...
        image_adj_file = os.path.join(self.dataset_path, 'image_adj_{}.pt'.format(self.knn_k))
        text_adj_file = os.path.join(self.dataset_path, 'text_adj_{}.pt'.format(self.knn_k))
