...
class CCC(GeneralRecommender):
    def __init__(self, config, dataset):
        super(CCC, self).__init__(config, dataset)
    ...
    def calculate_loss(self, interaction):
        ...
        # 加权总损失 (MENTOR 原始损失 + DGM 新的解耦损失 + 新的扩散损失)
        total_loss = loss_value + reg_loss + \
                     align_loss * self.align_weight + mask_f_loss + mask_g_loss + \
